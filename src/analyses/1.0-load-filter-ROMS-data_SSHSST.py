...
OSSE_SSHSST["w"] = OSSE_SSHSST.w.rolling(ocean_time=smoothWindow, center=True).mean()

print('clearing some variables')
OSSE_SSHSST = OSSE_SSHSST.drop('zeta_obc')
OSSE_SSHSST = OSSE_SSHSST.drop('DU_avg1')
OSSE_SSHSST = OSSE_SSHSST.drop('DU_avg2')
OSSE_SSHSST = OSSE_SSHSST.drop('ubar_obc')
OSSE_SSHSST = OSSE_SSHSST.drop('DV_avg1')
OSSE_SSHSST = OSSE_SSHSST.drop('DV_avg2')
OSSE_SSHSST = OSSE_SSHSST.drop('vbar_obc')
OSSE_SSHSST = OSSE_SSHSST.drop('u_obc')
OSSE_SSHSST = OSSE_SSHSST.drop('v_obc')
#OSSE_SSHSST = OSSE_SSHSST.drop('w')
OSSE_SSHSST = OSSE_SSHSST.drop('temp_obc')
OSSE_SSHSST = OSSE_SSHSST.drop('salt_obc')
OSSE_SSHSST = OSSE_SSHSST.drop('AKv')
OSSE_SSHSST = OSSE_SSHSST.drop('AKt')
OSSE_SSHSST = OSSE_SSHSST.drop('AKs')
OSSE_SSHSST = OSSE_SSHSST.drop('Pair')
OSSE_SSHSST = OSSE_SSHSST.drop('shflux')
OSSE_SSHSST = OSSE_SSHSST.drop('ssflux')
OSSE_SSHSST = OSSE_SSHSST.drop('Tair')
OSSE_SSHSST = OSSE_SSHSST.drop('EminusP')
OSSE_SSHSST = OSSE_SSHSST.drop('sustr')
OSSE_SSHSST = OSSE_SSHSST.drop('svstr')
...
OSSE_SSHSST = calc_5dayDownsample(OSSE_SSHSST)
