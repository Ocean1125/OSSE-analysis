...
filelist_SSHSST_XBT_PXLINES=generateFileList(hisOSSEFilePath5,prefixAnalysis,datelist)
filelist_SSHSST_XBT_PXLINES_MONTHLY=generateFileList(hisOSSEFilePath6,prefixAnalysis,datelist)
filelist_SSHSST_XBT_PXLINES_WEEKLY=generateFileList(hisOSSEFilePath7,prefixAnalysis,datelist)
filelist_SSHSST_XBT_PXLINES_2WEEKLY=generateFileList(hisOSSEFilePath8,prefixAnalysis,datelist)

truth=loadOverlappedNetcdfFileList(hisTruthFilePath,prefixTruth,filelist=filelistTruth,overlapDays=7)
OSSE_SSHSST_XBT_PXLINES_2WEEKLY=loadOSSEFileList(hisOSSEFilePath8,prefixAnalysis, filelist=filelist_SSHSST_XBT_PXLINES_2WEEKLY,overlapDays=7)


# data filtering. 8 samples == 32 hr smoothing.
smoothWindow=8

OSSE_SSHSST_XBT_PXLINES_2WEEKLY["u_eastward"] = OSSE_SSHSST_XBT_PXLINES_2WEEKLY.u_eastward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_2WEEKLY["v_northward"] = OSSE_SSHSST_XBT_PXLINES_2WEEKLY.v_northward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_2WEEKLY["temp"] = OSSE_SSHSST_XBT_PXLINES_2WEEKLY.temp.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_2WEEKLY["salt"] = OSSE_SSHSST_XBT_PXLINES_2WEEKLY.salt.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_2WEEKLY["zeta"] = OSSE_SSHSST_XBT_PXLINES_2WEEKLY.zeta.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_2WEEKLY["w"] = OSSE_SSHSST_XBT_PXLINES_2WEEKLY.w.rolling(ocean_time=smoothWindow, center=True).mean()

print('clearing some variables')
ds = OSSE_SSHSST_XBT_PXLINES_2WEEKLY
ds = ds.drop('zeta_obc')
ds = ds.drop('DU_avg1')
ds = ds.drop('DU_avg2')
ds = ds.drop('ubar_obc')
...
ds = ds.drop('sustr')
ds = ds.drop('svstr')
OSSE_SSHSST_XBT_PXLINES_2WEEKLY = ds

# downsample data to daily.

#OSSE_SSHSST_XBT_PXLINES_2WEEKLY = calc_dailyDownsample(OSSE_SSHSST_XBT_PXLINES_2WEEKLY)
OSSE_SSHSST_XBT_PXLINES_2WEEKLY = calc_5dayDownsample(OSSE_SSHSST_XBT_PXLINES_2WEEKLY)

# process into more useful format
OSSE_SSHSST_XBT_PXLINES_2WEEKLY=processROMSGrid(OSSE_SSHSST_XBT_PXLINES_2WEEKLY)


# grid = makeROMSGridObject(truth)

#import xroms
#OSSE_SSHSST_XBT_PXLINES_2WEEKLY["rho"] = xroms.density(OSSE_SSHSST_XBT_PXLINES_2WEEKLY.temp,OSSE_SSHSST_XBT_PXLINES_2WEEKLY.salt)

# output Names
outputPath = '/g/data/fu5/deg581/OSSE_analysis/data/proc/'
outputPrefix = 'output_'
expNames=['OSSE_SSHSST_XBT_PXLINES_2WEEKLY']
