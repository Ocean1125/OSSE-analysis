...
### calculate 500m cross-sections
print('calc horizontal sections')
truth_temp_500 = horizontalSectionROMS(grid, truth.temp, np.array([-500]))
OSSE_SSHSST_temp_500 = horizontalSectionROMS(grid, OSSE_SSHSST.temp, np.array([-500]))
OSSE_SSHSST_XBT_N_temp_500 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT_N.temp, np.array([-500]))
OSSE_SSHSST_XBT_S_temp_500 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT_S.temp, np.array([-500]))
OSSE_SSHSST_XBT_temp_500 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT.temp, np.array([-500]))

truth_temp_250 = horizontalSectionROMS(grid, truth.temp, np.array([-250]))
OSSE_SSHSST_temp_250 = horizontalSectionROMS(grid, OSSE_SSHSST.temp, np.array([-250]))
OSSE_SSHSST_XBT_N_temp_250 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT_N.temp, np.array([-250]))
OSSE_SSHSST_XBT_S_temp_250 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT_S.temp, np.array([-250]))
OSSE_SSHSST_XBT_temp_250 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT.temp, np.array([-250]))

truth_temp_1000 = horizontalSectionROMS(grid, truth.temp, np.array([-1000]))
OSSE_SSHSST_temp_1000 = horizontalSectionROMS(grid, OSSE_SSHSST.temp, np.array([-1000]))
OSSE_SSHSST_XBT_N_temp_1000 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT_N.temp, np.array([-1000]))
OSSE_SSHSST_XBT_S_temp_1000 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT_S.temp, np.array([-1000]))
OSSE_SSHSST_XBT_temp_1000 = horizontalSectionROMS(grid, OSSE_SSHSST_XBT.temp, np.array([-1000]))

# output Names
outputPath = '/g/data/fu5/deg581/OSSE_analysis/data/proc/'
outputPrefix = 'output_temp_'
expNames=['truth','OSSE_SSHSST','OSSE_SSHSST_XBT','OSSE_SSHSST_XBT_N','OSSE_SSHSST_XBT_S']
outputSuffix = '_'+str(timeRange[0])+'_'+str(timeRange[1])+'.nc'
...
ds = truth
ds = ds.drop(VarToKeep)
ds['temp_500'] = truth_temp_500
ds['temp_250'] = truth_temp_250
ds['temp_1000'] = truth_temp_1000
ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[0]+outputSuffix)
...
ds['temp_250'] = truth_temp_250
ds['temp_1000'] = truth_temp_1000
ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[1]+outputSuffix)
...
ds['temp_250'] = truth_temp_250
ds['temp_1000'] = truth_temp_1000
ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[2]+outputSuffix)

ds = OSSE_SSHSST_XBT_N
ds = ds.drop(VarToKeep)
ds['temp_500'] = truth_temp_500
ds['temp_250'] = truth_temp_250
ds['temp_1000'] = truth_temp_1000
ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[3]+outputSuffix)

ds = OSSE_SSHSST_XBT_S
ds = ds.drop(VarToKeep)
ds['temp_500'] = truth_temp_500
ds['temp_250'] = truth_temp_250
ds['temp_1000'] = truth_temp_1000
ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[4]+outputSuffix)
...
#     ds = eval(var)
#     ds = ds.drop(VarToKeep)
#     ds['mke_0'] = eval(var)+_mke_0
#     ds['eke_0'] = eval(var)+_eke_0
#     ds['mke_500'] = eval(var)+_mke_500
#     ds['eke_500'] = eval(var)+_eke_500
