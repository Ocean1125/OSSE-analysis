...
OSSE_SSHSST_XBT_PXLINES_MONTHLY=loadOSSEFileList(hisOSSEFilePath6,prefixAnalysis, filelist=filelist_SSHSST_XBT_PXLINES_MONTHLY,overlapDays=7)


# data filtering. 8 samples == 32 hr smoothing.
smoothWindow=8

OSSE_SSHSST_XBT_PXLINES_MONTHLY["u_eastward"] = OSSE_SSHSST_XBT_PXLINES_MONTHLY.u_eastward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_MONTHLY["v_northward"] = OSSE_SSHSST_XBT_PXLINES_MONTHLY.v_northward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_MONTHLY["temp"] = OSSE_SSHSST_XBT_PXLINES_MONTHLY.temp.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_MONTHLY["salt"] = OSSE_SSHSST_XBT_PXLINES_MONTHLY.salt.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_MONTHLY["zeta"] = OSSE_SSHSST_XBT_PXLINES_MONTHLY.zeta.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_MONTHLY["w"] = OSSE_SSHSST_XBT_PXLINES_MONTHLY.w.rolling(ocean_time=smoothWindow, center=True).mean()

print('clearing some variables')
ds = OSSE_SSHSST_XBT_PXLINES_MONTHLY
ds = ds.drop('zeta_obc')
ds = ds.drop('DU_avg1')
ds = ds.drop('DU_avg2')
ds = ds.drop('ubar_obc')
...
ds = ds.drop('sustr')
ds = ds.drop('svstr')
OSSE_SSHSST_XBT_PXLINES_MONTHLY = ds

# downsample data to daily.

#OSSE_SSHSST_XBT_PXLINES_MONTHLY = calc_dailyDownsample(OSSE_SSHSST_XBT_PXLINES_MONTHLY)
OSSE_SSHSST_XBT_PXLINES_MONTHLY = calc_5dayDownsample(OSSE_SSHSST_XBT_PXLINES_MONTHLY)

# process into more useful format
OSSE_SSHSST_XBT_PXLINES_MONTHLY=processROMSGrid(OSSE_SSHSST_XBT_PXLINES_MONTHLY)


# grid = makeROMSGridObject(truth)

#import xroms
#OSSE_SSHSST_XBT_PXLINES_MONTHLY["rho"] = xroms.density(OSSE_SSHSST_XBT_PXLINES_MONTHLY.temp,OSSE_SSHSST_XBT_PXLINES_MONTHLY.salt)

# output Names
outputPath = '/g/data/fu5/deg581/OSSE_analysis/data/proc/'
outputPrefix = 'output_'
expNames=['OSSE_SSHSST_XBT_PXLINES_MONTHLY']
