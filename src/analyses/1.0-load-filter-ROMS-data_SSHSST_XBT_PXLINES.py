...
OSSE_SSHSST_XBT_PXLINES=loadOSSEFileList(hisOSSEFilePath5,prefixAnalysis, filelist=filelist_SSHSST_XBT_PXLINES,overlapDays=7)


# data filtering. 8 samples == 32 hr smoothing.
smoothWindow=8

OSSE_SSHSST_XBT_PXLINES["u_eastward"] = OSSE_SSHSST_XBT_PXLINES.u_eastward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES["v_northward"] = OSSE_SSHSST_XBT_PXLINES.v_northward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES["temp"] = OSSE_SSHSST_XBT_PXLINES.temp.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES["salt"] = OSSE_SSHSST_XBT_PXLINES.salt.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES["zeta"] = OSSE_SSHSST_XBT_PXLINES.zeta.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES["w"] = OSSE_SSHSST_XBT_PXLINES.w.rolling(ocean_time=smoothWindow, center=True).mean()

print('clearing some variables')
ds = OSSE_SSHSST_XBT_PXLINES
ds = ds.drop('zeta_obc')
ds = ds.drop('DU_avg1')
ds = ds.drop('DU_avg2')
ds = ds.drop('ubar_obc')
...
ds = ds.drop('sustr')
ds = ds.drop('svstr')
OSSE_SSHSST_XBT_PXLINES = ds

# downsample data to daily.

#OSSE_SSHSST_XBT_PXLINES = calc_dailyDownsample(OSSE_SSHSST_XBT_PXLINES)
OSSE_SSHSST_XBT_PXLINES = calc_5dayDownsample(OSSE_SSHSST_XBT_PXLINES)

# process into more useful format
OSSE_SSHSST_XBT_PXLINES=processROMSGrid(OSSE_SSHSST_XBT_PXLINES)


# grid = makeROMSGridObject(truth)

#import xroms
#OSSE_SSHSST_XBT_PXLINES["rho"] = xroms.density(OSSE_SSHSST_XBT_PXLINES.temp,OSSE_SSHSST_XBT_PXLINES.salt)

# output Names
outputPath = '/g/data/fu5/deg581/OSSE_analysis/data/proc/'
outputPrefix = 'output_'
expNames=['OSSE_SSHSST_XBT_PXLINES']
