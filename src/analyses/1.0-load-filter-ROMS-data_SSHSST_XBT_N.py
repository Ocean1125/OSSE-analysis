...
OSSE_SSHSST_XBT_N["w"] = OSSE_SSHSST_XBT_N.w.rolling(ocean_time=smoothWindow, center=True).mean()
...
#import xroms
#OSSE_SSHSST_XBT_N["rho"] = xroms.density(OSSE_SSHSST_XBT_N.temp,OSSE_SSHSST_XBT_N.salt)

# output Names
outputPath = '/g/data/fu5/deg581/OSSE_analysis/data/proc/'
outputPrefix = 'output_'
expNames=['OSSE_SSHSST_XBT_N']
