...
hisTruthFilePath='/g/data/fu5/deg581/EAC_2yr_perturbedRun_test2/output/' # Perturbed file settings
...
truth["w"] = truth.w.rolling(ocean_time=smoothWindow, center=True).mean()
...
truth = calc_5dayDownsample(truth)
