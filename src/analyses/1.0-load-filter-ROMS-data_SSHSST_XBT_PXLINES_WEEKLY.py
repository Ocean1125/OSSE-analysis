...
OSSE_SSHSST_XBT_PXLINES_WEEKLY=loadOSSEFileList(hisOSSEFilePath7,prefixAnalysis, filelist=filelist_SSHSST_XBT_PXLINES_WEEKLY,overlapDays=7)


# data filtering. 8 samples == 32 hr smoothing.
smoothWindow=8

OSSE_SSHSST_XBT_PXLINES_WEEKLY["u_eastward"] = OSSE_SSHSST_XBT_PXLINES_WEEKLY.u_eastward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_WEEKLY["v_northward"] = OSSE_SSHSST_XBT_PXLINES_WEEKLY.v_northward.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_WEEKLY["temp"] = OSSE_SSHSST_XBT_PXLINES_WEEKLY.temp.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_WEEKLY["salt"] = OSSE_SSHSST_XBT_PXLINES_WEEKLY.salt.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_WEEKLY["zeta"] = OSSE_SSHSST_XBT_PXLINES_WEEKLY.zeta.rolling(ocean_time=smoothWindow, center=True).mean()
OSSE_SSHSST_XBT_PXLINES_WEEKLY["w"] = OSSE_SSHSST_XBT_PXLINES_WEEKLY.w.rolling(ocean_time=smoothWindow, center=True).mean()

print('clearing some variables')
ds = OSSE_SSHSST_XBT_PXLINES_WEEKLY
ds = ds.drop('zeta_obc')
ds = ds.drop('DU_avg1')
ds = ds.drop('DU_avg2')
ds = ds.drop('ubar_obc')
...
ds = ds.drop('sustr')
ds = ds.drop('svstr')
OSSE_SSHSST_XBT_PXLINES_WEEKLY = ds

# downsample data to daily.

#OSSE_SSHSST_XBT_PXLINES_WEEKLY = calc_dailyDownsample(OSSE_SSHSST_XBT_PXLINES_WEEKLY)
OSSE_SSHSST_XBT_PXLINES_WEEKLY = calc_5dayDownsample(OSSE_SSHSST_XBT_PXLINES_WEEKLY)

# process into more useful format
OSSE_SSHSST_XBT_PXLINES_WEEKLY=processROMSGrid(OSSE_SSHSST_XBT_PXLINES_WEEKLY)


# grid = makeROMSGridObject(truth)

#import xroms
#OSSE_SSHSST_XBT_PXLINES_WEEKLY["rho"] = xroms.density(OSSE_SSHSST_XBT_PXLINES_WEEKLY.temp,OSSE_SSHSST_XBT_PXLINES_WEEKLY.salt)

# output Names
outputPath = '/g/data/fu5/deg581/OSSE_analysis/data/proc/'
outputPrefix = 'output_'
expNames=['OSSE_SSHSST_XBT_PXLINES_WEEKLY']
