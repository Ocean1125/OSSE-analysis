...
print('calc MKE and EKE')
# calc_MKEandEKEall(truth)
# calc_MKEandEKEall(OSSE_SSHSST)
# calc_MKEandEKEall(OSSE_SSHSST_XBT)
...
### remove these tuple entries for some reason
...
### load the 0m surface fields
print('calc 0m energies')
...
# ds['mke_0'] = truth_mke_0
# ds['eke_0'] = truth_eke_0
# ds['mke_500'] = truth_mke_500
# ds['eke_500'] = truth_eke_500
# ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[0]+outputSuffix)


# ds = OSSE_SSHSST
# ds = ds.drop(VarToKeep)
# ds['mke_0'] = OSSE_SSHSST_mke_0
# ds['eke_0'] = OSSE_SSHSST_eke_0
# ds['mke_500'] = OSSE_SSHSST_mke_500
# ds['eke_500'] = OSSE_SSHSST_eke_500
# ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[1]+outputSuffix)

# ds = OSSE_SSHSST_XBT
# ds = ds.drop(VarToKeep)
# ds['mke_0'] = OSSE_SSHSST_XBT_mke_0
# ds['eke_0'] = OSSE_SSHSST_XBT_eke_0
# ds['mke_500'] = OSSE_SSHSST_XBT_mke_500
# ds['eke_500'] = OSSE_SSHSST_XBT_eke_500
# ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[2]+outputSuffix)

ds = OSSE_SSHSST_XBT_N
ds = ds.drop(VarToKeep)
ds['mke_0'] = OSSE_SSHSST_XBT_N_mke_0
ds['eke_0'] = OSSE_SSHSST_XBT_N_eke_0
ds['mke_500'] = OSSE_SSHSST_XBT_N_mke_500
ds['eke_500'] = OSSE_SSHSST_XBT_N_eke_500
ds.load().to_netcdf(path=outputPath+outputPrefix+expNames[3]+outputSuffix)

ds = OSSE_SSHSST_XBT_S
ds = ds.drop(VarToKeep)
ds['mke_0'] = OSSE_SSHSST_XBT_S_mke_0
ds['eke_0'] = OSSE_SSHSST_XBT_S_eke_0
ds['mke_500'] = OSSE_SSHSST_XBT_S_mke_500
ds['eke_500'] = OSSE_SSHSST_XBT_S_eke_500
