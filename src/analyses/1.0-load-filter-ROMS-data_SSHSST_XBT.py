...
OSSE_SSHSST_XBT["w"] = OSSE_SSHSST_XBT.w.rolling(ocean_time=smoothWindow, center=True).mean()

print('clearing some variables')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('zeta_obc')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('DU_avg1')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('DU_avg2')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('ubar_obc')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('DV_avg1')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('DV_avg2')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('vbar_obc')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('u_obc')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('v_obc')
#OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('w')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('temp_obc')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('salt_obc')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('AKv')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('AKt')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('AKs')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('Pair')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('shflux')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('ssflux')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('Tair')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('EminusP')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('sustr')
OSSE_SSHSST_XBT = OSSE_SSHSST_XBT.drop('svstr')
...
OSSE_SSHSST_XBT = calc_5dayDownsample(OSSE_SSHSST_XBT)
...
#import xroms
#OSSE_SSHSST_XBT["rho"] = xroms.density(OSSE_SSHSST_XBT.temp,OSSE_SSHSST_XBT.salt)

# output Names
outputPath = '/g/data/fu5/deg581/OSSE_analysis/data/proc/'
outputPrefix = 'output_'
expNames=['OSSE_SSHSST_XBT']
