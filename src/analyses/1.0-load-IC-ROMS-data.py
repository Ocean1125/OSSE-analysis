...
#get_ipython().system('jupyter nbconvert --to script --no-prompt 1.0-load-IC-ROMS-data.ipynb')
...
OSSE_SSHSST_inc["u_rho"]=grid.interp(OSSE_SSHSST_inc.u,axis="X",boundary="fill")
OSSE_SSHSST_inc["v_rho"]=grid.interp(OSSE_SSHSST_inc.v,axis="Y",boundary="fill")

OSSE_SSHSST_XBT_inc["u_rho"]=grid.interp(OSSE_SSHSST_XBT_inc.u,axis="X",boundary="fill")
OSSE_SSHSST_XBT_inc["v_rho"]=grid.interp(OSSE_SSHSST_XBT_inc.v,axis="Y",boundary="fill")

OSSE_SSHSST_XBT_N_inc["u_rho"]=grid.interp(OSSE_SSHSST_XBT_N_inc.u,axis="X",boundary="fill")
OSSE_SSHSST_XBT_N_inc["v_rho"]=grid.interp(OSSE_SSHSST_XBT_N_inc.v,axis="Y",boundary="fill")

OSSE_SSHSST_XBT_S_inc["u_rho"]=grid.interp(OSSE_SSHSST_XBT_S_inc.u,axis="X",boundary="fill")
OSSE_SSHSST_XBT_S_inc["v_rho"]=grid.interp(OSSE_SSHSST_XBT_S_inc.v,axis="Y",boundary="fill")
